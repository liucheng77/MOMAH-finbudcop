...
const RC_AGENTS = [
  ...
  { id: "a6", code: "UC-06", kind: "existing", icon: "▦", route: "perf",
    ...
    title: { en: "Agent · Performance Analysis, Expenditure and Executive Reports", ar: "وكيل · تحليل الأداء والإنفاق والتقارير التنفيذية", zh: "智能体 · 绩效分析、支出与执行报告" },
...
function RcWorkspace() {
  ...
  return (<div className="fade"><div className="card pad ws-frame">
    ...
    <div className="ws-grid2">
      ...
      {/* RIGHT — Multi-Agent Flow thumbnail + Orchestrator */}
      <div className="ws-right">
      <div className="ws-flowcard" onClick={() => setRoute("rcdata")} title={tr({ en: "Open Multi-Agent Flow", ar: "فتح تدفّق الوكلاء", zh: "打开多智能体流程" })}>
        <div className="ws-flowcard-h">{tr({ en: "Multi-Agent Flow", ar: "تدفّق متعدد الوكلاء", zh: "多智能体流程" })} <span className="open">↗</span></div>

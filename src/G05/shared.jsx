/* =========================================================================
   G-05 shared infrastructure — 财务报告总局 (General Directorate of Financial
   Reporting) shared layer.
   -------------------------------------------------------------------------
   Thin re-export barrel.  All UI primitives (DirectorateFlow, DeptWorkspace,
   UcBench, BusinessPlaza, etc.) and helpers (Hi, OrchNext, askHiAgent,
   ...
   the host App.jsx and by G-05, so there is no App.jsx round-trip.
   ========================================================================= */
export {
